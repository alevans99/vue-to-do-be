module.exports = [
    {
      ...
      timestamp: new Date(1649001286757),
      priority: 1,
      deadline: new Date(1650150000000),
    },
    {
      listId: "test",
      noteTitle: 'Second Test Title',
      noteText: 'This is the text of the second example note',
      timestamp: new Date(1629001286757),
      priority: 2,
      deadline: new Date(1690150000000),
    },
    {
      listId: "another",
    ...
    },
    {
      ...
      timestamp: new Date(1619001286757),
      priority: 2,
      deadline: new Date(1790150000000),
    },
  ];
